...
class ToolRegistry:
    ...
    def _register_default_tools(self):
        ...
        self.register(
            ...
            parameters={
                "target": {"type": "string", "required": True, "description": "Text or selector to find"}
            }
        )
        ...
        self.register(
            ...
            parameters={
                "target": {"type": "string", "required": True, "description": "Label, placeholder, or selector"},
        ...
        self.register(
            ...
            parameters={
                "target": {"type": "string", "required": True, "description": "Dropdown label or selector"},
                "option": {"type": "string", "required": True, "description": "Option text or value to select"}
            }
        )
        ...
        self.register(
            ...
            parameters={
                "selector": {"type": "string", "required": True, "description": "Input field selector"},
                "text": {"type": "string", "required": True, "description": "Text to type"}
            }
        )
        ...
        self.register(
            ...
            parameters={
                "target_y": {"type": "integer", "required": True, "description": "Target scroll position in pixels"}
            }
        )
        ...
        self.register(
            ...
            parameters={
                "duration": {"type": "float", "required": False, "description": "Base duration in seconds (default: 2.0)"}
            }
        )
